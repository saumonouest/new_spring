                     ...
                     <table class="table">
                      <tr>
                       ...
                       <td width="30%" height="500" rowspan="2">
                        ...
                        <tr>
                         <th width=35% class="text-center">시간</th>
                         <td width=65%>{{time}}</td>
                        </tr>
                        <tr>
                         <th width=35% class="text-center">인원</th>
                         <td width=65%>{{inwon}}</td>
                        </tr>
                      ...
                      <tr>
                       ...
                       <td width="35%" height="150">
                        <table class="table">
                         ...
                         <tr v-show="isInwon">
                          <td class="text-center">
                           <span class="btn btn-xs btn-info" v-for="i in inwon_list" style="margin:1px;"
                            @click="inwonSelect(i)"
                           >
                            {{i}}
                           </span>
...
<script>
 let reserveApp = Vue.createApp	({
	 ...
	 // data(), methods => Vue 클래스의 멤버변수, 멤버 메소드 => 사용시에는 반드시 this.
	 methods:{
		 reserve(){
		 ...
		 dataRecv(){
			 ...
			 // 404(파일명 레스트 컨트롤러 쪽에서 주소 틀린 거), 405(GET/POST), 400(매개변수 오류), 500(소스 에러)
 ...
 }).mount("#reserveApp") // section 태그 안에 있는 HTML만 제어
</script>
</body>
</html>
