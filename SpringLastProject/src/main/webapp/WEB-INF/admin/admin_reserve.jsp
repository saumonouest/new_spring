...
<div id="adminApp">
 <table class="table">
  ...
  <tr v-for="vo in reserve_list">
   ...
   <td class="text-center">
	<button class="btn-xs btn-success" v-if="vo.isReserve===1">승인 완료</button>
	<button class="btn-xs btn-info" v-else @click="ok(vo.rno)">승인 대기</button>
   </td>
  </tr>
 </table>
</div>
